...
function setup(){
    button = createSprite(359, 30);
    moon = createSprite(200, 200);
    FM = createSprite(350, 200);
    WNG = createSprite(300, 100);
    LQM = createSprite(200, 50);
    WNC = createSprite(100, 100);
    NM = createSprite(50, 200);
    WXC = createSprite(100, 300);
    FQM = createSprite(200, 350);
    WXG = createSprite(300, 300);
...
function draw() {
  ...
  background("black");
  fill("white");
  text("PASSE O MOUSE SOBRE A LUA PARA VER A FASE E SEU NOME", 10, 385);
  if (mouseIsOver(FM)) {
    WNG.visible = 1;
    moon.setFrame(0);
    moon.pause();
